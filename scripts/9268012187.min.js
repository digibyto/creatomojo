(function (t, e, i, r, n, o) {
  ...
  function h(t, e) {
    e.removeContainer &&
      (t.parentNode.removeChild(t), D("Cleaned up container"));
  }
  function c(t, i) {
    ...
    return (
      ...
      r
        .getContext("2d")
        .drawImage(t, n, s, o - n, a - s, i.x, i.y, o - n, a - s),
      r
    );
  }
  function l(t) {
  ...
  function p(t, i) {
    for (
      var r =
          3 === t.nodeType ? e.createTextNode(t.nodeValue) : t.cloneNode(!1),
        n = t.firstChild;
      n;

    )
      (!0 !== i && 1 === n.nodeType && "SCRIPT" === n.nodeName) ||
        r.appendChild(p(n, i)),
        (n = n.nextSibling);
    return r;
  }
  function g(t, e, i, r, n, o, s) {
    x(t);
    var a = d()
        ? p(t.documentElement, n.javascriptEnabled)
        : t.documentElement.cloneNode(!0),
    ...
    return (
      ...
      new Promise(function (e) {
        ...
        m(t.documentElement, a, "textarea"),
            ...
            function () {
              var r = setInterval(function () {
                i.body.childNodes.length > 0 &&
                  (w(t, i),
                  clearInterval(r),
                  "view" === n.type && h.contentWindow.scrollTo(o, s),
                  e(h));
              }, 50);
            }),
          i.open(),
          ...
          v(t, o, s),
          i.replaceChild(
            !0 === n.javascriptEnabled ? i.adoptNode(a) : S(i.adoptNode(a)),
            i.documentElement
          ),
          i.close();
      })
  ...
  function v(t, e, i) {
    !t.defaultView ||
      (e === t.defaultView.pageXOffset && i === t.defaultView.pageYOffset) ||
      t.defaultView.scrollTo(e, i);
  }
  ...
  function M(t) {
    ...
    e
      ...
      (this.colorStops = t.args.slice(e ? 1 : 0).map(function (t) {
        ...
        return { color: new T(e[1]), stop: "%" === e[3] ? e[2] / 100 : null };
      }, this)),
      ...
      this.colorStops.forEach(function (t, e) {
        null === t.stop &&
          this.colorStops.slice(e).some(function (i, r) {
            return (
              null !== i.stop &&
              ((t.stop =
                (i.stop - this.colorStops[e - 1].stop) / (r + 1) +
  ...
  function V(t) {
    var e = t.offsetParent ? V(t.offsetParent) : { top: 0, left: 0 };
    return {
  ...
  function W(t, e, i, r, n) {
    ...
    if (
      (n.background &&
        e.rectangle(0, 0, e.width, e.height, new T(n.background)),
    ...
    (o.visibile = o.isElementVisible()),
      ...
      (this.ready = this.images.ready.then(
        yt(function () {
          return (
            D("Images loaded, starting parsing"),
  ...
  function $(t, e, i) {
    var r = t.left,
      ...
      b = s - p;
    return {
      topLeftOuter: J(r, n, a, h).topLeft.subdivide(0.5),
      topLeftInner: J(
        r + i[3].width,
        n + i[0].width,
        Math.max(0, a - i[3].width),
        Math.max(0, h - i[0].width)
      ).topLeft.subdivide(0.5),
      topRightOuter: J(r + g, n, c, l).topRight.subdivide(0.5),
      topRightInner: J(
        r + Math.min(g, o + i[3].width),
        n + i[0].width,
        g > o + i[3].width ? 0 : c - i[3].width,
        l - i[0].width
      ).topRight.subdivide(0.5),
      bottomRightOuter: J(r + v, n + m, u, f).bottomRight.subdivide(0.5),
      bottomRightInner: J(
        r + Math.min(v, o - i[3].width),
        n + Math.min(m, s + i[0].width),
        Math.max(0, u - i[1].width),
        f - i[2].width
      ).bottomRight.subdivide(0.5),
      bottomLeftOuter: J(r, n + b, d, p).bottomLeft.subdivide(0.5),
      bottomLeftInner: J(
        r + i[3].width,
        n + b,
        Math.max(0, d - i[3].width),
        p - i[2].width
  ...
  function vt(t) {
    return function (e, i) {
      return (
        ...
        (i.cssInt("zIndex") + t.indexOf(i) / t.length)
      );
    };
  }
  function bt(t) {
  ...
  function Tt(e) {
    for (var i, r = [], n = 0, o = !1; e.length; )
      Ot(e[n]) === o
        ? ((i = e.splice(0, n)).length &&
            r.push(t.html2canvas.punycode.ucs2.encode(i)),
          (o = !o),
          (n = 0))
        : n++,
        n >= e.length &&
  ...
  function Pt(t, e, i) {
    return (
      ...
      (i.length ? "&callback=html2canvas.proxy." + i : "")
    );
  }
  function Mt(t, i) {
  ...
  function Nt(t) {
    var e,
      ...
      l = "";
    for (e = 0; e < c; e += 4)
      (o = (h.indexOf(t[e]) << 2) | ((i = h.indexOf(t[e + 1])) >> 4)),
  ...
  if (
    (function () {
      ...
      function x(t, e, i, r) {
        (this.n = t),
          ...
          this.o(e)
            ? ((this.m = e),
              (this.d = this.length = e.length),
              this.l(),
              0 === this.length
                ? d(this.c, this.b)
                : ((this.length = this.length || 0),
                  this.k(),
                  0 === this.d && d(this.c, this.b)))
            : p(this.c, this.p());
      }
      function w(t) {
      ...
      (x.prototype.o = function (t) {
        ...
        (x.prototype.k = function () {
          for (
            var t = this.length, e = this.c, i = this.m, r = 0;
            void 0 === e.a && r < t;
            r++
          )
            this.j(i[r], r);
        ...
        (x.prototype.j = function (t, e) {
          ...
          "object" == typeof t && null !== t
            ? t.constructor === i && void 0 !== t.a
              ? ((t.f = null), this.g(t.a, e, t.b))
              : this.q(i.resolve(t), e)
            : (this.d--, (this.b[e] = this.h(t)));
        }),
        (x.prototype.g = function (t, e, i) {
          var r = this.c;
          void 0 === r.a &&
            (this.d--, this.i && 2 === t ? p(r, i) : (this.b[e] = this.h(i))),
            0 === this.d && d(r, this.b);
        }),
      ...
      var I = {
        ...
        polyfill: function () {
          var e;
          ("Promise" in
            (e = void 0 !== r ? r : void 0 !== t && t.document ? t : self) &&
      ...
      "function" == typeof n && n.amd
        ...
        ? (module.exports = I)
        : void 0 !== this && (this.ES6Promise = I);
    }.call(t),
    t && t.ES6Promise.polyfill(),
    void 0 !== e &&
    ...
    !(function (t) {
      ...
      function f(t) {
        ...
        for (o = r > 0 ? r + 1 : 0; o < m; ) {
          for (
            s = v, a = 1, l = x;
            o >= m && e("invalid-input"),
              ((f = c(t.charCodeAt(o++))) >= x || f > M((y - v) / a)) &&
                e("overflow"),
              (v += f * a),
              (d = l <= C ? w : l >= C + S ? S : l - C),
              !(f < d);
      ...
      if (
        ...
        if (module.exports == p) g.exports = v;
    ...
    (t.html2canvas = function (i, r) {
      ...
      if (
        ...
        (r.async = void 0 === r.async || r.async),
        (r.allowTaint = void 0 !== r.allowTaint && r.allowTaint),
        (r.removeContainer = void 0 === r.removeContainer || r.removeContainer),
        (r.javascriptEnabled =
          void 0 !== r.javascriptEnabled && r.javascriptEnabled),
        (r.imageTimeout = void 0 === r.imageTimeout ? 1e4 : r.imageTimeout),
        (r.renderer = "function" == typeof r.renderer ? r.renderer : Yt),
        (r.strict = !!r.strict),
        "string" == typeof i)
      ) {
        ...
        s(
          ...
          if ("function" == typeof r.onrendered)
            if (
              ...
              void 0 === r.grabMouse || r.grabMouse)
            ) {
    ...
    (E.prototype.getMetrics = function (t, e) {
      return (
        this.data[t + "-" + e] === o && (this.data[t + "-" + e] = new k(t, e)),
        this.data[t + "-" + e]
      );
    }),
      ...
      (j.prototype.TYPES = { LINEAR: 1, RADIAL: 2 }),
      ...
      (P.prototype.loadImage = function (t) {
        ...
        return "linear-gradient" === t.method
          ...
          ? new Vt(t)
          : "svg" === t.method
          ? new Gt(t.args[0], this.support.svg)
          : "IFRAME" === t.method
      ...
      (P.prototype.getOrigin = function (t) {
        ...
        return (
          (i.href = t), (i.href = i.href), i.protocol + i.hostname + i.port
        );
      }),
      ...
      (P.prototype.fetch = function (t) {
        return (
          (this.images = t.reduce(
            yt(this.findBackgroundImage, this),
            this.findImages(t)
          )),
      ...
      ((M.prototype = Object.create(j.prototype)).stepRegExp =
      ...
      (L.prototype.parseTextShadows = function () {
        ...
        if (t && "none" !== t)
          for (
            var i = t.match(this.TEXT_SHADOW_PROPERTY), r = 0;
            i && r < i.length;
            r++
          ) {
      ...
      (L.prototype.parseBounds = function () {
        return (this.bounds = this.hasTransform()
          ? V(this.node)
          : z(this.node));
      }),
      ...
      (L.prototype.TEXT_SHADOW_PROPERTY =
        /((rgba|rgb)\([^\)]+\)(\s-?\d+px){0,})/g),
      (L.prototype.TEXT_SHADOW_VALUES =
        /(-?\d+px)|(#.+)|(rgb\(.+\))|(rgba\(.+\))/g),
      ...
      (W.prototype.createPseudoHideStyles = function (t) {
        this.createStyles(
          t,
          "." +
            Dt.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE +
            ':before { content: "" !important; display: none !important; }.' +
            Dt.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER +
      ...
      (W.prototype.getChildren = function (t) {
        return Ct(
          [].filter.call(t.node.childNodes, ht).map(function (e) {
            var i = [
              e.nodeType === Node.TEXT_NODE ? new Xt(e, t) : new L(e, t),
            ].filter(St);
      ...
      (W.prototype.paint = function (t) {
        try {
          t instanceof U
            ...
            : mt(t)
            ? (gt(t.parent) && t.parent.appendToDOM(),
              this.paintText(t),
              gt(t.parent) && t.parent.cleanDOM())
            : this.paintNode(t);
        } catch (t) {
              ...
              switch (t.node.nodeName) {
                ...
                case "IFRAME":
                  ...
                  i
                    ...
                    : D("Error loading <" + t.node.nodeName + ">", t.node);
                  break;
                case "VIDEO":
                  var r = {
                    image: t.node,
                  ...
                  break;
                case "IMG":
                  (r = this.images.get(t.node.src))
                    ? this.renderer.renderImage(t, e, t.borders, r)
                    : D("Error loading <img>", t.node.src);
                  break;
                case "CANVAS":
      ...
      (W.prototype.paintCheckbox = function (t) {
        var e = t.parseBounds(),
          ...
          r = { width: i - 1, height: i - 1, top: e.top, left: e.left },
          n = [3, 3],
          o = [n, n, n, n],
          s = [1, 1, 1, 1].map(function (t) {
            return { color: new T("#A5A5A5"), width: t };
          }),
          a = $(r, o, s);
        this.renderer.clip(
          t.backgroundClip,
          function () {
            this.renderer.rectangle(
              ...
              t.node.checked &&
                ...
                this.renderer.text("✔", r.left + i / 6, r.top + i - 1));
          },
          this
        );
      }),
            ...
            this.renderer.circleStroke(
              ...
              t.node.checked &&
                this.renderer.circle(
                  Math.ceil(e.left + i / 4) + 1,
                  Math.ceil(e.top + i / 4) + 1,
                  Math.floor(i / 2),
                  new T("#424242")
                );
          },
      ...
      (W.prototype.paintText = function (e) {
        ...
        var i = t.html2canvas.punycode.ucs2.decode(e.node.data),
          r =
            (this.options.letterRendering && !st(e)) || kt(e.node.data)
              ? i.map(function (e) {
          ...
          this.renderer.clip(
            ...
            function () {
              r.map(this.parseTextBounds(e), this).forEach(function (t, i) {
                t &&
                  (this.renderer.text(r[i], t.left, t.bottom),
                  this.renderTextDecoration(
                    e.parent,
                    t,
                    this.fontMetrics.getMetrics(s, o)
                  ));
              }, this);
            },
            this
      ...
      (W.prototype.renderTextDecoration = function (t, e, i) {
        switch (t.css("textDecoration").split(" ")[0]) {
          case "underline":
            this.renderer.rectangle(
              e.left,
              Math.round(e.top + i.baseline + i.lineWidth),
              e.width,
              1,
              t.color("color")
            );
          ...
          case "line-through":
            this.renderer.rectangle(
              e.left,
              Math.ceil(e.top + i.middle + i.lineWidth),
              e.width,
              1,
              t.color("color")
            );
    ...
    (Dt.prototype.cloneTo = function (t) {
      ...
      (Lt.prototype.renderImage = function (t, e, i, r) {
        ...
        this.drawImage(
          ...
          0,
          0,
          r.image.width || r.image.clientWidth || c,
          r.image.height || r.image.clientHeight || l,
          e.left + n + h[3].width,
          e.top + o + h[0].width,
          c,
          l
      ...
      (Lt.prototype.renderBackground = function (t, e, i) {
        e.height > 0 &&
          ...
          this.renderBackgroundImage(t, e, i));
      }),
            ...
            switch (r.method) {
              case "url":
                ...
                s
                  ...
                  : D("Error loading background-image", r.args[0]);
                break;
              case "linear-gradient":
              case "gradient":
                var a = this.images.get(r.value);
                a
                  ? this.renderBackgroundGradient(a, e, i)
                  : D("Error loading background-image", r.args[0]);
                break;
              case "none":
                break;
      ...
      ((Rt.prototype = Object.create(L.prototype)).getParentStack = function (
        t
      ) {
      ...
      (Bt.prototype.testRangeBounds = function (t) {
        ...
        return (
          t.createRange &&
            ...
            (((i = t.createElement("boundtest")).style.height = "123px"),
        ...
        return function (i, r) {
          ...
          (e.image = n.lowerCanvasEl),
            n
              .setWidth(r.width)
              .setHeight(r.height)
              .add(html2canvas.fabric.util.groupSVGElements(i, r))
              .renderAll(),
            t(n.lowerCanvasEl);
        };
      }),
      ...
      ((Xt.prototype = Object.create(L.prototype)).applyTextTransform =
        function () {
      ...
      ((Yt.prototype = Object.create(Lt.prototype)).setFillStyle = function (
        t
      ) {
        return (
          (this.ctx.fillStyle =
      ...
      (Yt.prototype.drawImage = function (t, e, i, r, n, o, s, a, h) {
        "VIDEO" !== t.image.nodeName.toUpperCase()
          ? (this.taints(t) && !this.options.allowTaint) ||
            this.ctx.drawImage(t.image, e, i, r, n, o, s, a, h)
          : this.ctx.drawImage(t.image, e, i, r, n, o, s, a, h);
      }),
      ...
      (Yt.prototype.backgroundRepeatShape = function (
        t,
        e,
        i,
        r,
        ...
        var c = [
          ["line", Math.round(n), Math.round(o)],
          ["line", Math.round(n + s), Math.round(o)],
          ["line", Math.round(n + s), Math.round(a + o)],
          ["line", Math.round(n), Math.round(a + o)],
        ];
        this.clip(
          [c],
          function () {
      ...
      (Yt.prototype.renderBackgroundRepeat = function (t, e, i, r, n, o) {
        ...
        this.setFillStyle(
          this.ctx.createPattern(this.resizeImage(t, i), "repeat")
        ),
      ...
      (Yt.prototype.renderBackgroundGradient = function (t, e) {
        if (t instanceof M) {
          var i = this.ctx.createLinearGradient(
            e.left + e.width * t.x0,
            e.top + e.height * t.y0,
            e.left + e.width * t.x1,
            e.top + e.height * t.y1
      ...
      (Yt.prototype.resizeImage = function (t, i) {
        ...
        return (
          ...
          n
            .getContext("2d")
            .drawImage(r, 0, 0, r.width, r.height, 0, 0, i.width, i.height),
          n
        );
      });
    var se = !!e.all;
    se || e.captureEvents(Event.MOUSEMOVE),
      e.addEventListener(
        ...
        function (t) {
          return (
            se
              ? ((ae = event.clientX + e.body.scrollLeft),
                (he = event.clientY + e.body.scrollTop))
              : ((ae = t.pageX), (he = t.pageY)),
            ae < 0 && (ae = 0),
            he < 0 && (he = 0),
            !0
          );
  ...
  function (window, document, exports, undefined) {
    ...
    var Cufon = (function () {
      ...
      function e() {
        var t = {},
          e = { oblique: "italic", italic: "oblique" };
        (this.add = function (e) {
          ...
          (this.get = function (i, r) {
            ...
            if (!n) return null;
            if (((r = { normal: 400, bold: 700 }[r] || parseInt(r, 10)), n[r]))
              return n[r];
            var o,
              s,
              a = { 1: 1, 99: 0 }[r % 100],
      ...
      function n(t, e) {
        ...
        return i.options
          ? t
          : (e.hover && e.hoverables[t.nodeName.toLowerCase()] && m.attach(t),
            (i.options = e),
            t);
      }
      function o(t) {
      ...
      function s(t, e) {
        ...
        for (
          var i,
            r = d.quotedList(e.get("fontFamily").toLowerCase()),
            n = 0,
            o = r.length;
          n < o;
          ++n
      ...
      function h() {
        for (var t, e = {}, i = 0, r = arguments.length; i < r; ++i)
          for (t in arguments[i]) e[t] = arguments[i][t];
        return e;
      }
      ...
      function l(t, e) {
        for (var i, r, o, a, h = n(t, e).firstChild; h; h = o) {
          ...
          if ((r || (r = d.getStyle(t).extend(e)), i || (i = s(t, r)), i))
            if (a) b[e.engine](i, null, r, e, h, t);
            else {
              var l = h.data;
              if (
      ...
      var u = function () {
          ...
          ready: (function () {
            ...
            return (
              fabric.document.addEventListener &&
                (fabric.document.addEventListener("DOMContentLoaded", n, !1),
                fabric.window.addEventListener("pageshow", n, !1)),
              !fabric.window.opera &&
                fabric.document.readyState &&
                (function () {
                  e[fabric.document.readyState]
                    ? n()
        ...
        d = (u.CSS = {
          ...
          ready: (function () {
            ...
            return (
              f.ready(function () {
                ...
                fabric.document.styleSheets.length >= r.length + e
                  ? i()
                  : setTimeout(arguments.callee, 10);
              }),
              function (i) {
          ...
          textDecoration: function (t, e) {
            e || (e = this.getStyle(t));
            for (
              var i = { underline: null, overline: null, "line-through": null },
                r = t;
              r.parentNode && 1 == r.parentNode.nodeType;

            ) {
              var n = !0;
              for (var o in i)
                i[o] ||
                  (-1 != e.get("textDecoration").indexOf(o) &&
                    (i[o] = e.get("color")),
                  (n = !1));
              if (n) break;
        ...
        m = new (function () {
          ...
          this.attach = function (t) {
            t.onmouseenter === undefined
              ? (r(t, "mouseover", e), r(t, "mouseout", e))
              : (r(t, "mouseenter", i), r(t, "mouseleave", i));
          };
        })(),
        v = [],
        b = {},
      ...
      return (
        ...
        (u.replace = function (t, e, i) {
          return (e = h(x, e)).engine
            ? ("string" == typeof e.textShadow &&
                e.textShadow &&
                (e.textShadow = d.textShadow(e.textShadow)),
              i || v.push(arguments),
              (t.nodeType || "string" == typeof t) && (t = [t]),
              d.ready(function () {
                for (var i = 0, r = t.length; i < r; ++i) {
                  var n = t[i];
                  "string" == typeof n
                    ? u.replace(e.selector(n), e, !0)
                    : l(n, e);
                }
              }),
              u)
        ...
        (u.replaceElement = function (t, e) {
          return (
            "string" == typeof (e = h(x, e)).textShadow &&
              e.textShadow &&
              (e.textShadow = d.textShadow(e.textShadow)),
            l(t, e)
          );
    ...
    Cufon.registerEngine(
      ...
      (function () {
          ...
          t: for (var a = 0; (i = s.exec(t)); ++a) {
            ...
            switch (i[1]) {
              case "v":
                ...
                break;
              case "r":
                o[a] = { m: "lineTo", a: [(r += ~~h[0]), (n += ~~h[1])] };
                break;
              case "m":
                o[a] = { m: "moveTo", a: [(r = ~~h[0]), (n = ~~h[1])] };
                break;
              case "x":
                o[a] = { m: "closePath", a: [] };
                break;
        ...
        n.type = "text/css";
        var o = fabric.document.createTextNode(
          ".cufon-canvas{text-indent:0}@media screen,projection{.cufon-canvas{display:inline;display:inline-block;position:relative;vertical-align:middle" +
            (r ? "" : ";font-size:1px;line-height:1px") +
        ...
        return (
          fabric.document.getElementsByTagName("head")[0].appendChild(n),
          function (r, n, o, s, a, h) {
            function c(i) {
              ...
              "right" === s.textAlign
                ? W.translate(I[a], 0)
                : "center" === s.textAlign && W.translate(I[a] / 2, 0);
                ...
                if ("\n" !== _[h]) {
                  ...
                  if (l) {
                    ...
                    U &&
                      ...
                      W.beginPath(),
                      U.underline &&
                        (W.moveTo(0, 0.5 - r.face["underline-position"]),
                        W.lineTo(u, 0.5 - r.face["underline-position"])),
                      U.overline &&
                        (W.moveTo(0, r.ascent + 0.5),
                        W.lineTo(u, r.ascent + 0.5)),
                      U["line-through"] &&
                        (W.moveTo(0, 0.5 - r.descent),
                        W.lineTo(u, 0.5 - r.descent)),
                      W.stroke(),
                      W.restore()),
                      q && (W.save(), W.transform(1, 0, -0.25, 1, 0, 0)),
                      W.beginPath(),
                      l.d &&
                        (l.code ? e(l.code, W) : (l.code = t("m" + l.d, W))),
                      W.fill(),
                      s.strokeStyle &&
                        (W.closePath(),
                        W.save(),
                        (W.lineWidth = s.strokeWidth),
                        (W.strokeStyle = s.strokeStyle),
                        W.stroke(),
                        W.restore()),
                      q && W.restore(),
                      W.translate(u, 0),
                  ...
                  "right" === s.textAlign
                    ? (W.translate(-T, f), W.translate(I[a], 0))
                    : "center" === s.textAlign
                    ? (W.translate(-n - I[a - 1] / 2, f),
                      W.translate(I[a] / 2, 0))
                    : W.translate(-n, f),
                    (n = 0);
                }
            ...
            for (
              var _ = Cufon.CSS.textTransform(l ? a.alt : n, o).split(""),
                T = 0,
                O = null,
                k = 0,
                E = 1,
              ...
              } else E++, T > k && (k = T), A.push(T), (T = 0);
            A.push(T), (T = Math.max(k, T));
            for (var I = [], y = A.length; y--; ) I[y] = T - A[y];
            if (null === O) return null;
            (g += u.width - O), (m += u.minX);
            var P, M;
            if (l) (P = a), (M = a.firstChild);
            else if (
              ((P = fabric.document.createElement("span")),
              (P.className = "cufon cufon-canvas"),
              (P.alt = n),
              (M = fabric.document.createElement("canvas")),
              P.appendChild(M),
              s.printable)
            ) {
            ...
            (Cufon.textOptions.width = G),
              ...
              i
                ? ((L.width = X), (L.height = z + "px"))
                : ((L.paddingLeft = X), (L.paddingBottom = z - 1 + "px"));
            ...
            W.save(),
              ...
              W.translate(
                -m -
                  ((1 / Y) * M.width) / 2 +
                  (Cufon.fonts[r.family].offsetLeft || 0),
                -p -
                  Cufon.textOptions.height / Y / 2 +
                  (Cufon.fonts[r.family].offsetTop || 0)
              ),
            ...
            if (
              ...
              (function () {
                ...
                s.backgroundColor &&
                  ...
                  W.translate(0, r.ascent),
                  W.fillRect(0, 0, T + 10, (-r.ascent + r.descent) * E),
                  W.restore()),
                  "right" === s.textAlign
                    ? (W.translate(I[e], 0), (i[0].left = I[e] * Y))
                    : "center" === s.textAlign &&
                      (W.translate(I[e] / 2, 0), (i[0].left = (I[e] / 2) * Y));
                  ...
                  if ("\n" !== _[n]) {
                    ...
                    if (a) {
                      ...
                      s.textBackgroundColor &&
                        (W.save(),
                        (W.fillStyle = s.textBackgroundColor),
                        W.translate(0, r.ascent),
                        W.fillRect(0, 0, h + 10, -r.ascent + r.descent),
                        W.restore()),
                        W.translate(h, 0),
                        (t += h),
                        n == o - 1 &&
                          ((i[i.length - 1].width = t * Y),
                          (i[i.length - 1].height =
                            (-r.ascent + r.descent) * Y));
                    }
                  } else {
                    e++;
                ...
                return (
                  ...
                  function (i, r, n, o, s, a, h) {
                    ...
                    var l = i.viewBox,
                      u =
                        n.computedFontSize ||
                        (n.computedFontSize = new Cufon.CSS.Size(
                          t(a, n.get("fontSize")) + "px",
                          i.baseSize
                        )),
                      f = n.computedLSpacing;
                    f == undefined &&
                      ((f = n.get("letterSpacing")),
                      (n.computedLSpacing = f =
                        "normal" == f ? 0 : ~~u.convertFrom(e(a, f))));
                    var d, p;
                    if (c) (d = s), (p = s.firstChild);
                    else {
                      if (
                        ((d = fabric.document.createElement("span")),
                        (d.className = "cufon cufon-vml"),
                        (d.alt = r),
                        (p = fabric.document.createElement("span")),
                        (p.className = "cufon-vml-canvas"),
                        d.appendChild(p),
                        o.printable)
                      ) {
                      ...
                      h ||
                        d.appendChild(
                          fabric.document.createElement("cvml:shape")
                        );
                    }
                    var m = d.style,
                      v = p.style,
                    ...
                    for (
                      var C,
                        _,
                        T = n.get("color"),
                        O = Cufon.CSS.textTransform(r, n).split(""),
                        k = 0,
                        E = 0,
                        A = null,
                        j = o.textShadow,
                    ...
                    for (I = 0; I < M; ++I)
                      if ((C = i.glyphs[O[I]] || i.missingGlyph)) {
                        c
                          ? (_ = p.childNodes[P]).firstChild &&
                            _.removeChild(_.firstChild)
                          : ((_ = fabric.document.createElement("cvml:shape")),
                            p.appendChild(_)),
                          (_.stroked = "f"),
                          (_.coordsize = F),
                    ...
                    return (
                      (m.width = Math.max(Math.ceil(u.convert(k * x)), 0)), d
                    );
                  }
                );
            }
        ...
        function str(t, e) {
          ...
          switch (
            (h &&
              ...
              (h = h.toJSON(t)),
            "function" == typeof rep && (h = rep.call(e, t, h)),
            typeof h)
          ) {
            case "string":
              return quote(h);
      ...
      (fabric.Collection = {
        ...
        remove: function () {
          for (
            var t, e = this.getObjects(), i = 0, r = arguments.length;
            i < r;
            i++
          )
            -1 !== (t = e.indexOf(arguments[i])) &&
              (e.splice(t, 1), this._onObjectRemoved(arguments[i]));
          return this.renderOnAddRemove && this.renderAll(), this;
        },
      ...
      (function (t) {
        ...
        fabric.util = {
          ...
          resolveNamespace: function (e) {
            if (!e) return fabric;
            for (
              var i = e.split("."), r = i.length, n = t || fabric.window, o = 0;
              o < r;
              ++o
            )
              n = n[i[o]];
          ...
          multiplyTransformMatrices: function (t, e) {
            for (
              ...
              n[o] = [];
              for (var s = 0; s < 3; s++) {
                for (var a = 0, h = 0; h < 3; h++) a += i[o][h] * r[h][s];
                n[o][s] = a;
              }
            }
      ...
      (function () {
        function t(t, n, s, a, h, c, l) {
          ...
          var f = Math.PI,
            ...
            T = 0;
          if (_ < 0) {
            var O = Math.sqrt(1 - (0.25 * _) / (x * w));
            (s *= O), (a *= O);
          } else T = (h === c ? -0.5 : 0.5) * Math.sqrt(_ / (x * S + w * C));
          var k = (T * s * y) / a,
            E = (-T * a * b) / s,
            A = g * k - p * E + t / 2,
            j = p * k + g * E + n / 2,
          ...
          for (
            var M = Math.ceil(Math.abs(P / (0.5 * f))),
              D = [],
              L = P / M,
              R =
                ((8 / 3) * Math.sin(L / 4) * Math.sin(L / 4)) / Math.sin(L / 2),
              B = I + L,
              F = 0;
            F < M;
            F++
          )
            (D[F] = e(I, B, g, p, s, a, A, j, R, m, v)),
              (m = D[F][4]),
              (v = D[F][5]),
              (I += L),
              (B += L);
      ...
      (function () {
        ...
        fabric.util.array = {
          invoke: function (t, i) {
            for (
              var r = e.call(arguments, 2), n = [], o = 0, s = t.length;
              o < s;
              o++
            )
              ...
              (e[r] + "").indexOf("callSuper") > -1
                ? (t.prototype[r] = (function (t) {
                    return function () {
                      ...
                      if (
                        ((this.constructor.superclass = r), "initialize" !== t)
                      )
                        return n;
                    };
                  })(r))
        ...
        fabric.util.createClass = function () {
          ...
          "function" == typeof a[0] && (s = a.shift()),
            ...
            s &&
              ...
              (n.prototype = new t()),
              s.subclasses.push(n));
          for (var h = 0, c = a.length; h < c; h++) o(n, a[h], s);
          return (
      ...
      (function () {
        function t(t) {
          ...
          for (i = 0; i < n; i++)
            if (
              ((e = typeof t[r[i]]), !/^(?:function|object|unknown)$/.test(e))
            )
              return !1;
          return !0;
        }
        ...
        fabric.isTouchSupported &&
          ...
          (fabric.util.getPointer = function (t, e) {
            ...
            var i =
                t.target || (typeof t.srcElement !== a ? t.srcElement : null),
              r = fabric.util.getScrollLeftTop(i, e);
            return { x: g(t) + r.left, y: m(t) + r.top };
          }),
        ...
        (n =
          ...
          (fabric.util.getScrollLeftTop = function (t, e) {
            ...
            for (r = t; t && t.parentNode && !i; )
              (t = t.parentNode) !== fabric.document &&
                "fixed" === fabric.util.getElementStyle(t, "position") &&
                (i = t),
                t !== fabric.document &&
                r !== e &&
                "absolute" === fabric.util.getElementStyle(t, "position")
                  ? ((n = 0), (o = 0))
                  : t === fabric.document
                  ? ((n = a.scrollLeft || s.scrollLeft || 0),
                    (o = a.scrollTop || s.scrollTop || 0))
                  : ((n += t.scrollLeft || 0), (o += t.scrollTop || 0));
            return { left: n, top: o };
          }),
      ...
      (function (t) {
        ...
        function i(t, e, i) {
          ...
          return (
            ("fill" !== t && "stroke" !== t) || "none" !== e
              ? "fillRule" === t
                ? (e = "evenodd" === e ? "destination-over" : e)
                : "strokeDashArray" === t
                ? (e = e
                    .replace(/,/g, " ")
                    .split(/\s+/)
                ...
                ? (e =
                    i && i.transformMatrix
                      ? w(i.transformMatrix, g.parseTransformAttribute(e))
                      : g.parseTransformAttribute(e))
                : "visible" === t
                ? ((e = "none" !== e && "hidden" !== e),
                  i && !1 === i.visible && (e = !1))
                : "originX" === t
        ...
        function a(t) {
          ...
          for (var i in g.cssRules)
            if (h(t, i.split(" ")))
              for (var r in g.cssRules[i]) e[r] = g.cssRules[i][r];
          return e;
        }
        function h(t, e) {
          var i,
        ...
        function u(t) {
          for (var e = t.getElementsByTagName("use"); e.length; ) {
            for (
              var i = e[0],
                r = i.getAttribute("xlink:href").substr(1),
                n = i.getAttribute("x") || 0,
                o = i.getAttribute("y") || 0,
                s = t.getElementById(r).cloneNode(!0),
                a =
              ...
              "x" !== u.nodeName &&
                "y" !== u.nodeName &&
                "xlink:href" !== u.nodeName &&
                ("transform" === u.nodeName
                  ? (a = a + " " + u.nodeValue)
                  : s.setAttribute(u.nodeName, u.nodeValue));
            }
        ...
        function f(t, e) {
          if (
            ((e[3] = e[0] = e[0] > e[3] ? e[3] : e[0]),
            1 !== e[0] || 1 !== e[3] || 0 !== e[4] || 0 !== e[5])
          ) {
            for (
              var i = t.ownerDocument.createElement("g");
              null != t.firstChild;
              ...
              if (i) {
                ...
                if (0 === w.length && g.isLikelyNode) {
                  for (
                    var S = [],
                      C = 0,
                      _ = (w = i.selectNodes('//*[name(.)!="svg"]')).length;
                    C < _;
                    C++
                  )
                    S[C] = w[C];
        ...
        m(g, {
          getGradientDefs: function (t) {
            ...
            for (; a--; )
              (n = (e = h[a]).getAttribute("xlink:href")),
                (r = e.getAttribute("id")),
                n && (l[r] = n.substr(1)),
                (c[r] = e);
            for (r in l) {
          ...
          parseAttributes: function (t, n) {
            if (t) {
              var o,
                s = {};
              t.parentNode &&
                /^symbol|[g|a]$/i.test(t.parentNode.nodeName) &&
                (s = g.parseAttributes(t.parentNode, n));
              var h = n.reduce(function (r, n) {
                return (
                  (o = t.getAttribute(n)) &&
                    ((n = e(n)), (o = i(n, o, s)), (r[n] = o)),
                  r
                );
              }, {});
          ...
          getCSSRules: function (t) {
            for (
              var r = t.getElementsByTagName("style"),
                n = {},
                o = 0,
                s = r.length;
              o < s;
          ...
          createSVGRefElementsMarkup: function (t) {
            var e = [];
            return (
              p(e, t, "backgroundColor"), p(e, t, "overlayColor"), e.join("")
            );
          },
        });
      })(void 0 !== exports ? exports : this),
      ...
      (fabric.ElementsParser.prototype.resolveGradient = function (t, e) {
        ...
        if (/^url\(/.test(i)) {
          ...
          fabric.gradientDefs[r] &&
            t.set(e, fabric.Gradient.fromElement(fabric.gradientDefs[r], t));
        }
      }),
            ...
            (i.Intersection.intersectLineLine = function (t, r, n, o) {
              ...
              if (0 !== c) {
                var l = a / c,
                  u = h / c;
                0 <= l && l <= 1 && 0 <= u && u <= 1
                  ? (s = new e("Intersection")).points.push(
            ...
            (r.Color.prototype = {
              _tryParsingColor: function (t) {
                ...
                t in e.colorNameMap && (t = e.colorNameMap[t]),
                  "transparent" !== t
                    ? ((i = e.sourceFromHex(t)) || (i = e.sourceFromRgb(t)),
              ...
              _rgbToHsl: function (t, e, i) {
                ...
                if (((s = (a + h) / 2), a === h)) n = o = 0;
                  ...
                  var c = a - h;
                  switch (((o = s > 0.5 ? c / (2 - a - h) : c / (a + h)), a)) {
                    case t:
                      n = (e - i) / c + (e < i ? 6 : 0);
                      break;
                    case e:
              ...
              overlayWith: function (t) {
                ...
                for (
                  ...
                  i.push(Math.round(0.5 * n[s] + 0.5 * o[s]));
      ...
      (function () {
        ...
        function r(t, e, i) {
          ...
          for (var a in e)
            (r = parseFloat(e[a], 10)),
              (o = "string" == typeof e[a] && /^\d+%$/.test(e[a]) ? 0.01 : 1),
              "x1" === a || "x2" === a || "r2" === a
        ...
        (fabric.Gradient = fabric.util.createClass({
          ...
          toSVG: function (t) {
            ...
            for (var o = 0; o < this.colorStops.length; o++)
              e.push(
                "<stop ",
                'offset="',
                100 * this.colorStops[o].offset + "%",
                '" style="stop-color:',
                this.colorStops[o].color,
                null != this.colorStops[o].opacity
          ...
          fabric.util.object.extend(fabric.Gradient, {
            fromElement: function (n, o) {
              ...
              return (
                (l || "" !== s) &&
                  (p.gradientTransform = fabric.parseTransformAttribute(
                    (l || "") + s
                  )),
                p
              );
        ...
        toObject: function () {
          ...
          return (
            "function" == typeof this.source
              ...
              : "string" == typeof this.source.src && (t = this.source.src),
            {
              source: t,
              repeat: this.repeat,
              offsetX: this.offsetX,
        ...
        e.Shadow
          ...
          : ((e.Shadow = e.util.createClass({
              ...
              toSVG: function (t) {
                ...
                return (
                  !t ||
                    (t.fill !== this.color && t.stroke !== this.color) ||
                    (e = "SourceGraphic"),
                  '<filter id="SVGID_' +
                    this.id +
              ...
              toObject: function () {
                ...
                return (
                  this.color !== i.color && (t.color = this.color),
          ...
          (fabric.StaticCanvas = fabric.util.createClass({
            ...
            setDimensions: function (t, e) {
              ...
              for (var r in t)
                (i = t[r]),
                  e.cssOnly ||
                    (this._setBackstoreDimension(r, t[r]), (i += "px")),
            ...
            getZoom: function () {
              return Math.sqrt(
                this.viewportTransform[0] * this.viewportTransform[3]
              );
            },
            ...
            _renderBackground: function (t) {
              this.backgroundColor &&
                ((t.fillStyle = this.backgroundColor.toLive
                  ? this.backgroundColor.toLive(t)
                  : this.backgroundColor),
                t.fillRect(
            ...
            _renderOverlay: function (t) {
              this.overlayColor &&
                ((t.fillStyle = this.overlayColor.toLive
                  ? this.overlayColor.toLive(t)
                  : this.overlayColor),
                t.fillRect(
            ...
            centerObject: function (t) {
              ...
              return (
                this._centerObject(t, new fabric.Point(e.left, e.top)),
                this.renderAll(),
                this
              );
            },
            ...
            __serializeBgOverlay: function () {
              ...
              return (
                ...
                this.backgroundImage &&
                  (t.backgroundImage = this.backgroundImage.toObject()),
                this.overlayImage &&
                  (t.overlayImage = this.overlayImage.toObject()),
                t
              );
            },
            ...
            _setSVGHeader: function (t, e) {
              var i, r, n;
              e.viewBox
                ? ((i = e.viewBox.width), (r = e.viewBox.height))
                : ((i = this.width),
                  (r = this.height),
                  this.svgViewportTransformation ||
                    ((i /= (n = this.viewportTransform)[0]), (r /= n[3]))),
                t.push(
                  "<svg ",
            ...
            dispose: function () {
              return (
                this.clear(), this.interactive && this.removeListeners(), this
              );
            },
            toString: function () {
              return (
        ...
        fabric.PencilBrush = fabric.util.createClass(fabric.BaseBrush, {
          ...
          getPathBoundingBox: function (i) {
            ...
            return (
              r.push(o.x),
              n.push(o.y),
              { minX: t(r), minY: t(n), maxX: e(r), maxY: e(n) }
            );
          },
          convertPointsToSVGPath: function (t, e, i) {
            ...
            for (var s = 1, a = t.length; s < a; s++) {
              ...
              r.push("Q ", n.x, " ", n.y, " ", h.x, " ", h.y, " "),
                ...
                s + 1 < t.length &&
                  (o = new fabric.Point(t[s + 1].x - e, t[s + 1].y - i));
            }
          ...
          _finalizeAndAddPath: function () {
            ...
            if ("M 0 0 Q 0 0 0 0 L 0 0" !== t) {
              ...
              r.set({ left: e, top: i, originX: "center", originY: "center" }),
                this.canvas.add(r),
                r.setCoords(),
                this.canvas.clearContext(this.canvas.contextTop),
                this._resetShadow(),
      ...
      (fabric.CircleBrush = fabric.util.createClass(fabric.BaseBrush, {
        ...
        onMouseUp: function () {
          ...
          var s = new fabric.Group(e, { originX: "center", originY: "center" });
      ...
      (fabric.SprayBrush = fabric.util.createClass(fabric.BaseBrush, {
        ...
        addSprayChunk: function (t) {
          ...
          for (var e, i, r, n = this.width / 2, o = 0; o < this.density; o++) {
            ...
            (s.width = r),
              this.randomOpacity &&
                (s.opacity = fabric.util.getRandomInt(0, 100) / 100),
      ...
      fabric.util.object.extend(fabric.StaticCanvas.prototype, {
        toDataURL: function (t) {
          ...
          return 1 !== r
            ? this.__toDataURLWithMultiplier(e, i, n, r)
            : this.__toDataURL(e, i, n);
        },
        __toDataURL: function (t, e, i) {
          ...
          "jpg" === t && (t = "jpeg");
          var o = fabric.StaticCanvas.supports("toDataURLWithQuality")
        ...
        __getCroppedCanvas: function (t, e) {
          var i, r;
          return (
            ("left" in e || "top" in e || "width" in e || "height" in e) &&
              ((r = (i = fabric.util.createCanvasElement()).getContext("2d")),
        ...
        __setBgOverlay: function (t, e, i, r) {
          ...
          e
            ? "backgroundImage" === t || "overlayImage" === t
              ...
              : this["set" + fabric.util.string.capitalize(t, !0)](
                  e,
                  function () {
                    (i[t] = !0), r && r();
                  }
          ...
          ((e.Object = e.util.createClass({
            ...
            _renderControls: function (t, i) {
              ...
              if ((t.save(), this.active && !i)) {
                var n;
                this.group &&
                  ((n = e.util.transformPoint(this.group.getCenterPoint(), r)),
                  t.translate(n.x, n.y),
                  t.rotate(o(this.group.angle))),
                  ...
                  this.group &&
                    ((n.x *= this.group.scaleX), (n.y *= this.group.scaleY)),
                  t.translate(n.x, n.y),
                  t.rotate(o(this.angle)),
                  this.drawBorders(t),
                  this.drawControls(t);
            ...
            _renderFill: function (t) {
              if (this.fill) {
                ...
                "destination-over" === this.fillRule
                  ? t.fill("evenodd")
                  : t.fill(),
                  t.restore(),
                  this.shadow &&
            ...
            toDataURL: function (t) {
              ...
              this.set("active", !1),
                this.setPositionByOrigin(
                  new e.Point(i.width / 2, i.height / 2),
                  "center",
                  "center"
                );
              var s = this.canvas;
            ...
            _setupFillRule: function (t) {
              this.fillRule &&
                ((this._prevFillRule = t.globalCompositeOperation),
                (t.globalCompositeOperation = this.fillRule));
            },
      ...
      (function () {
        ...
        fabric.util.object.extend(fabric.Object.prototype, {
          translateToCenterPoint: function (e, i, r) {
            ...
            return (
              "left" === i
                ? (n = e.x + (this.getWidth() + s * this.scaleX) / 2)
                : "right" === i &&
                  (n = e.x - (this.getWidth() + s * this.scaleX) / 2),
              "top" === r
                ? (o = e.y + (this.getHeight() + s * this.scaleY) / 2)
                : "bottom" === r &&
                  (o = e.y - (this.getHeight() + s * this.scaleY) / 2),
          ...
          toLocalPoint: function (e, i, r) {
            ...
            return (
              i && r
                ? ((n =
                    "left" === i
                      ? s.x - (this.getWidth() + a * this.scaleX) / 2
                      : "right" === i
                      ? s.x + (this.getWidth() + a * this.scaleX) / 2
                      : s.x),
                  (o =
                    "top" === r
                      ? s.y - (this.getHeight() + a * this.scaleY) / 2
                      : "bottom" === r
                      ? s.y + (this.getHeight() + a * this.scaleY) / 2
                      : s.y))
                : ((n = this.left), (o = this.top)),
              fabric.util
                .rotatePoint(new fabric.Point(e.x, e.y), s, -t(this.angle))
                .subtractEquals(new fabric.Point(n, o))
            );
          },
          ...
          adjustPosition: function (e) {
            var i = t(this.angle),
              ...
              a = Math.cos(i) * s,
              h = Math.sin(i) * s;
            ("center" === this.originX && "left" === e) ||
            ("right" === this.originX && "center" === e)
              ? ((this.left -= n), (this.top -= o))
              : ("left" === this.originX && "center" === e) ||
                ("center" === this.originX && "right" === e)
              ? ((this.left += n), (this.top += o))
      ...
      (function () {
        ...
        fabric.util.object.extend(fabric.Object.prototype, {
          ...
          intersectsWithRect: function (t, e) {
            ...
            return (
              "Intersection" ===
              fabric.Intersection.intersectPolygonRectangle([r, n, s, o], t, e)
                .status
            );
          },
          ...
          getBoundingRect: function () {
            ...
            return { left: e, top: o, width: r, height: Math.abs(o - s) };
          },
          getWidth: function () {
          ...
          setCoords: function () {
            var e = this.strokeWidth > 1 ? this.strokeWidth : 0,
              ...
              s = this.height,
              a =
                "round" === this.strokeLineCap ||
                "square" === this.strokeLineCap,
      ...
      fabric.util.object.extend(fabric.Object.prototype, {
        getSvgStyles: function () {
          var t = this.fill
              ...
              : "none",
            e =
              "destination-over" === this.fillRule ? "evenodd" : this.fillRule,
            i = this.stroke
              ? this.stroke.toLive
        ...
        getSvgTransform: function () {
          ...
          var t = fabric.util.toFixed,
            ...
            s = 0 !== e ? " rotate(" + t(e, n) + ")" : "",
            a =
              1 === this.scaleX && 1 === this.scaleY && 1 === i[0] && 1 === i[3]
                ? ""
                : " scale(" +
                  t(this.scaleX * i[0], n) +
                  " " +
      ...
      (function (t) {
        ...
        i.Line
          ...
          : ((i.Line = i.util.createClass(i.Object, {
              ...
              _set: function (t, e) {
                return (
                  (this[t] = e), void 0 !== n[t] && this._setWidthHeight(), this
                );
              },
              _getLeftToOriginX: e(
                {
              ...
              _render: function (t, e) {
                ...
                if (!this.strokeDashArray || (this.strokeDashArray && o)) {
                  ...
                  t.moveTo(
                    1 === this.width ? 0 : (r * this.width) / 2,
                    1 === this.height ? 0 : (n * this.height) / 2
                  ),
                    t.lineTo(
                      1 === this.width ? 0 : (-1 * r * this.width) / 2,
                      1 === this.height ? 0 : (-1 * n * this.height) / 2
                    );
                }
                t.lineWidth = this.strokeWidth;
                var s = t.strokeStyle;
        ...
        i.Circle
          ...
          : ((i.Circle = i.util.createClass(i.Object, {
              ...
              toSVG: function (t) {
                ...
                return (
                  this.group &&
                    ((i = this.left + this.radius),
                    (r = this.top + this.radius)),
                  e.push(
                    "<circle ",
                    'cx="' + i + '" cy="' + r + '" ',
                    'r="',
        ...
        e.Triangle
          ...
          : ((e.Triangle = e.util.createClass(e.Object, {
              ...
              initialize: function (t) {
                (t = t || {}),
                  this.callSuper("initialize", t),
                  this.set("width", t.width || 100).set(
                    "height",
                    t.height || 100
                  );
              },
          ...
          r.push("rx", "ry", "x", "y"),
            (e.Rect = e.util.createClass(e.Object, {
              ...
              toObject: function (t) {
                ...
                return (
                  this.includeDefaultValues || this._removeDefaultValues(e), e
                );
              },
              toSVG: function (t) {
                var e = this._createBaseSVGMarkup(),
                  ...
                  r = this.top;
                return (
                  this.group || ((i = -this.width / 2), (r = -this.height / 2)),
                  e.push(
                    "<rect ",
                    'x="',
                    i,
            ...
            (e.Rect.fromElement = function (t, r) {
              ...
              return (
                (n.left = n.left || 0),
                (n.top = n.top || 0),
                new e.Rect(i(r ? e.util.object.clone(r) : {}, n))
              );
            }),
        ...
        e.Polyline
          ...
          : ((e.Polyline = e.util.createClass(e.Object, {
            ...
            (e.Polyline.fromElement = function (t, i) {
              ...
              return null === r
                ? null
                : new e.Polyline(r, e.util.object.extend(n, i));
            }),
      ...
      (function (t) {
        ...
        var r = t.fabric || (t.fabric = {}),
          ...
          l = { m: "l", M: "L" };
        r.Path
          ? r.warn("fabric.Path is already defined")
          : ((r.Path = r.util.createClass(r.Object, {
              type: "path",
              path: null,
              initialize: function (t, e) {
              ...
              _initializePath: function (t) {
                ...
                e && i
                  ...
                  : (s(this, this._parseDimensions()),
                    e && (this.width = t.width),
                    i && (this.height = t.height)),
                  (this.pathOffset =
                    this.pathOffset || this._calculatePathOffset(o, a));
              },
              ...
              toObject: function (t) {
                ...
                return (
                  ...
                  this.transformMatrix &&
                    (e.transformMatrix = this.transformMatrix),
                  e
                );
              },
              toDatalessObject: function (t) {
              ...
              _parsePath: function () {
                for (
                  ...
                  for (
                    r = (t = this.path[h]).slice(1).trim(), s.length = 0;
                    (i = a.exec(r));
            ...
            (r.Path.fromObject = function (t, e) {
              "string" == typeof t.path
                ? r.loadSVGFromURL(t.path, function (i) {
                    var n = i[0],
                      o = t.path;
                    delete t.path,
            ...
            (r.Path.ATTRIBUTE_NAMES = r.SHARED_ATTRIBUTES.concat(["d"])),
            (r.Path.fromElement = function (t, e, i) {
        ...
        if (!e.Group) {
          ...
          (e.Group = e.util.createClass(e.Object, e.Collection, {
            ...
            _moveFlippedObject: function (t) {
              ...
              return (
                t.set({ originX: e, originY: i, left: n.x, top: n.y }), this
              );
            },
            _toggleFlipping: function (t) {
              this.flipX &&
                (t.toggle("flipX"),
                t.set("left", -t.get("left")),
                t.setAngle(-t.getAngle())),
                this.flipY &&
                  (t.toggle("flipY"),
                  t.set("top", -t.get("top")),
                  t.setAngle(-t.getAngle()));
            ...
            _getRotatedLeftTop: function (t) {
              ...
              return {
                left:
                  -Math.sin(e) * t.getTop() * this.get("scaleY") +
                  Math.cos(e) * t.getLeft() * this.get("scaleX"),
                top:
                  Math.cos(e) * t.getTop() * this.get("scaleY") +
                  Math.sin(e) * t.getLeft() * this.get("scaleX"),
              };
            },
            destroy: function () {
              return (
            ...
            _calcBounds: function (t) {
              for (
                var e, i = [], r = [], n = 0, o = this._objects.length;
                n < o;
                ++n
              ) {
            ...
            : ((fabric.Image = fabric.util.createClass(fabric.Object, {
                ...
                initialize: function (t, e) {
                  e || (e = {}),
                    ...
                    this._initConfig(e),
                    e.filters &&
                      ((this.filters = e.filters), this.applyFilters());
                },
                getElement: function () {
                ...
                toObject: function (t) {
                  return e(this.callSuper("toObject", t), {
                    src:
                      this._originalElement.src || this._originalElement._src,
                ...
                toSVG: function (t) {
                  var e = [],
                    ...
                    r = -this.height / 2;
                  if (
                    (this.group && ((i = this.left), (r = this.top)),
                    e.push(
                      '<g transform="',
                      this.getSvgTransform(),
                      this.getSvgTransformMatrix(),
                ...
                applyFilters: function (t) {
                  if (this._originalElement) {
                    if (0 === this.filters.length)
                      return (
                        (this._element = this._originalElement), void (t && t())
                      );
      ...
      (function (t) {
        ...
        var e = t.fabric || (t.fabric = {}),
          i = e.util.object.extend;
        (e.Image.filters.Brightness = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "Brightness",
            initialize: function (t) {
      ...
      (function (t) {
        ...
        var e = t.fabric || (t.fabric = {}),
          i = e.util.object.extend;
        (e.Image.filters.Convolute = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "Convolute",
            initialize: function (t) {
            ...
            applyTo: function (t) {
              for (
                var e = this.matrix,
                  ...
                  n = Math.round(Math.sqrt(e.length)),
                  o = Math.floor(n / 2),
                  s = r.data,
                  a = r.width,
                  h = r.height,
      ...
      (function (t) {
        ...
        var e = t.fabric || (t.fabric = {}),
          i = e.util.object.extend;
        (e.Image.filters.GradientTransparency = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
      ...
      (function (t) {
        "use strict";
        var e = t.fabric || (t.fabric = {});
        (e.Image.filters.Grayscale = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "Grayscale",
            applyTo: function (t) {
      ...
      (function (t) {
        "use strict";
        var e = t.fabric || (t.fabric = {});
        (e.Image.filters.Invert = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "Invert",
            applyTo: function (t) {
        ...
        (e.Image.filters.Mask = e.util.createClass(e.Image.filters.BaseFilter, {
          ...
          initialize: function (t) {
            (t = t || {}),
              (this.mask = t.mask),
              (this.channel =
                [0, 1, 2, 3].indexOf(t.channel) > -1 ? t.channel : 0);
          },
          applyTo: function (t) {
            if (this.mask) {
              var i,
      ...
      (function (t) {
        ...
        var e = t.fabric || (t.fabric = {}),
          i = e.util.object.extend;
        (e.Image.filters.Noise = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "Noise",
            initialize: function (t) {
      ...
      (function (t) {
        ...
        var e = t.fabric || (t.fabric = {}),
          i = e.util.object.extend;
        (e.Image.filters.Pixelate = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "Pixelate",
            initialize: function (t) {
      ...
      (function (t) {
        ...
        var e = t.fabric || (t.fabric = {}),
          i = e.util.object.extend;
        (e.Image.filters.RemoveWhite = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "RemoveWhite",
            initialize: function (t) {
      ...
      (function (t) {
        "use strict";
        var e = t.fabric || (t.fabric = {});
        (e.Image.filters.Sepia = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "Sepia",
            applyTo: function (t) {
              var e,
                ...
                s = o.length;
              for (e = 0; e < s; e += 4)
                (i = 0.3 * o[e] + 0.59 * o[e + 1] + 0.11 * o[e + 2]),
                  (o[e] = i + 100),
                  (o[e + 1] = i + 50),
                  (o[e + 2] = i + 255);
              r.putImageData(n, 0, 0);
      ...
      (function (t) {
        "use strict";
        var e = t.fabric || (t.fabric = {});
        (e.Image.filters.Sepia2 = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "Sepia2",
            applyTo: function (t) {
      ...
      (function (t) {
        ...
        var e = t.fabric || (t.fabric = {}),
          i = e.util.object.extend;
        (e.Image.filters.Multiply = e.util.createClass(
          e.Image.filters.BaseFilter,
          {
            type: "Multiply",
            initialize: function (t) {
            ...
            applyTo: function (t) {
              var i,
                ...
                a = s.length;
              for (
                r = new e.Color(this.color).getSource(), i = 0;
                i < a;
                i += 4
              )
                (s[i] *= r[0] / 255),
        ...
        if (e.Text) e.warn("fabric.Text is already defined");
          ...
          s.push(
            ...
            (e.Text = e.util.createClass(e.Object, {
              ...
              _render: function (t) {
                void 0 === Cufon || !0 === this.useNative
                  ? this._renderViaNative(t)
                  : this._renderViaCufon(t);
              },
              ...
              _getTextWidth: function (t, e) {
                for (
                  var i = t.measureText(e[0] || "|").width, r = 1, n = e.length;
                  r < n;
                  r++
                ) {
                ...
                if (((n -= this.fontSize / 4), "justify" === this.textAlign)) {
                  ...
                  if (a > s)
                    for (
                      var h = i.split(/\s+/),
                        c =
                          (a - e.measureText(i.replace(/\s+/g, "")).width) /
                          (h.length - 1),
                        l = 0,
                        u = 0,
                        f = h.length;
                      ...
                      this._renderChars(t, e, h[u], r + l, n, o),
              ...
              _renderTextFill: function (t, e) {
                if (this.fill || this._skipFillStrokeCheck) {
                  ...
                  for (var i = 0, r = 0, n = e.length; r < n; r++)
                    (i += this._getHeightOfLine(t, r, e)),
                      this._renderTextLine(
                        "fillText",
                        t,
                        e[r],
                        this._getLeftOffset(),
                        this._getTopOffset() + i,
                        r
                      );
                }
              },
                ...
                if (
                  ...
                  t.save(),
                    this.strokeDashArray &&
                      ...
                      o && t.setLineDash(this.strokeDashArray)),
                    t.beginPath();
              ...
              _renderTextDecoration: function (t, e) {
                function i(i) {
                  for (var o = 0, s = e.length; o < s; o++) {
                    ...
                    t.fillRect(
                      n._getLeftOffset() + h,
                      ~~(i + o * n._getHeightOfLine(t, o, e) - r),
                      a,
                      1
                    );
                  }
              ...
              _getSVGShadows: function (t, i) {
                ...
                for (r = 0, o = i.length; r < o; r++)
                  if ("" !== i[r]) {
                    var h =
                      this._boundaries && this._boundaries[r]
                        ? this._boundaries[r].left
                        : 0;
                    s.push(
                      '<tspan x="',
                      n(h + a + this.shadow.offsetX, 2),
                      0 === r || this.useNative ? '" y' : '" dy',
                      '="',
                      n(
                        this.useNative
                          ? t * r - this.height / 2 + this.shadow.offsetY
                          : t + (0 === r ? this.shadow.offsetY : 0),
                        2
                      ),
                      '" ',
              ...
              _getSVGTextAndBg: function (t, e, i) {
                ...
                for (var s = 0, a = i.length; s < a; s++)
                  "" !== i[s]
                    ? (this._setSVGTextLineText(i[s], s, r, t, o, n), (o = 1))
                    : o++,
                    this.textBackgroundColor &&
                      this._boundaries &&
                      this._setSVGTextLineBg(n, s, e, t);
                return { textSpans: r, textBgRects: n };
              },
              _setSVGTextLineText: function (t, i, r, o, s) {
                var a =
                  this._boundaries && this._boundaries[i]
                    ? n(this._boundaries[i].left, 2)
                    : 0;
                r.push(
                  '<tspan x="',
                  a,
                  '" ',
                  0 === i || this.useNative ? "y" : "dy",
                  '="',
                  n(this.useNative ? o * i - this.height / 2 : o * s, 2),
                  '" ',
                  this._getFillAttributes(this.fill),
                  ">",
                  e.util.string.escapeXml(t),
                  "</tspan>"
                );
              },
              _setSVGTextLineBg: function (t, e, i, r) {
                t.push(
                  ...
                  ' x="',
                  n(i + this._boundaries[e].left, 2),
                  '" y="',
                  n(r * e - this.height / 2, 2),
                  '" width="',
                  n(this._boundaries[e].width, 2),
                  '" height="',
                  n(this._boundaries[e].height, 2),
                  '"></rect>\n'
                );
              },
              ...
              _set: function (t, e) {
                "fontFamily" === t &&
                  ...
                  this.callSuper("_set", t, e),
                  t in this._dimensionAffectingProps &&
